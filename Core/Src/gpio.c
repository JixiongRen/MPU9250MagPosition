...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, MPU9250_CHIP_G3S3_Pin|MPU9250_CHIP_G3S4_Pin|LED0_Pin|LED1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MPU9250_CHIP_G2S3_Pin|MPU9250_CHIP_G2S4_Pin|MPU9250_CHIP_G3S1_Pin|MPU9250_CHIP_G3S2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MPU9250_CHIP_G1S1_Pin|MPU9250_CHIP_G1S2_Pin|MPU9250_CHIP_G1S3_Pin|MPU9250_CHIP_G1S4_Pin
                          |MPU9250_CHIP_G2S1_Pin|MPU9250_CHIP_G2S2_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = MPU9250_CHIP_G3S3_Pin|MPU9250_CHIP_G3S4_Pin|LED0_Pin|LED1_Pin;
